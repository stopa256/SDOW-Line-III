...
void main ()
{
  ...
  tmpvar_13 = normalize((tmpvar_11 + normalize(
    (tmpvar_10 * (((_World2Object * tmpvar_12).xyz * unity_Scale.w) - _glesVertex.xyz))
  )));
  tmpvar_6 = tmpvar_13;
...
void main ()
{
  ...
  lowp float spec_5;
  lowp float tmpvar_6;
  tmpvar_6 = max (0.0, dot (tmpvar_3, xlv_TEXCOORD3));
  mediump float tmpvar_7;
  tmpvar_7 = (pow (tmpvar_6, (_Shininess * 128.0)) * tmpvar_2.w);
  spec_5 = tmpvar_7;
  c_4.xyz = (((
    (tmpvar_2.xyz * _LightColor0.xyz)
   * 
    max (0.0, dot (tmpvar_3, xlv_TEXCOORD1))
  ) + (_LightColor0.xyz * spec_5)) * 2.0);
  c_4.w = 0.0;
  c_1.w = c_4.w;
...
void main ()
{
  ...
  tmpvar_12 = max (0.0, dot (tmpvar_3, xlv_TEXCOORD3));
  mediump float tmpvar_13;
  tmpvar_13 = (pow (tmpvar_12, (_Shininess * 128.0)) * tmpvar_2.w);
  spec_11 = tmpvar_13;
  c_10.xyz = (((
    (tmpvar_2.xyz * _LightColor0.xyz)
   * 
    max (0.0, dot (tmpvar_3, xlv_TEXCOORD1))
  ) + (_LightColor0.xyz * spec_11)) * (tmpvar_4 * 2.0));
  c_10.w = 0.0;
  c_1.w = c_10.w;
...
void main ()
{
  ...
  tmpvar_14 = normalize((tmpvar_12 + normalize(
    (tmpvar_11 * (((_World2Object * tmpvar_13).xyz * unity_Scale.w) - _glesVertex.xyz))
  )));
  tmpvar_6 = tmpvar_14;
  ...
  tmpvar_36 = (max (vec4(0.0, 0.0, 0.0, 0.0), (
    (((tmpvar_32 * tmpvar_8.x) + (tmpvar_33 * tmpvar_8.y)) + (tmpvar_34 * tmpvar_8.z))
   * 
...
void main ()
{
  ...
  xlv_TEXCOORD2 = tmpvar_5;
  xlv_TEXCOORD3 = tmpvar_6;
  xlv_TEXCOORD4 = (unity_World2Shadow[0] * cse_31);
}
...
void main ()
{
  ...
  lowp float spec_8;
  lowp float tmpvar_9;
  tmpvar_9 = max (0.0, dot (tmpvar_3, xlv_TEXCOORD3));
  mediump float tmpvar_10;
  tmpvar_10 = (pow (tmpvar_9, (_Shininess * 128.0)) * tmpvar_2.w);
  spec_8 = tmpvar_10;
  c_7.xyz = (((
    (tmpvar_2.xyz * _LightColor0.xyz)
   * 
    max (0.0, dot (tmpvar_3, xlv_TEXCOORD1))
  ) + (_LightColor0.xyz * spec_8)) * (shadow_4 * 2.0));
  c_7.w = 0.0;
  c_1.w = c_7.w;
...
void main ()
{
  ...
  tmpvar_10 = max (0.0, dot (tmpvar_3, xlv_TEXCOORD3));
  mediump float tmpvar_11;
  tmpvar_11 = (pow (tmpvar_10, (_Shininess * 128.0)) * tmpvar_2.w);
  spec_9 = tmpvar_11;
  c_8.xyz = (((
    (tmpvar_2.xyz * _LightColor0.xyz)
   * 
    max (0.0, dot (tmpvar_3, xlv_TEXCOORD1))
  ) + (_LightColor0.xyz * spec_9)) * (shadow_4 * 2.0));
  c_8.w = 0.0;
  c_1.w = c_8.w;
