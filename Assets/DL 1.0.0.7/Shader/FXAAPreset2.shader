...
void main ()
{
  ...
  if ((tmpvar_35 < tmpvar_36)) {
    ...
    doneN_5 = bool(0);
    doneP_4 = bool(0);
    posN_10 = (posN_10 + (tmpvar_63 * vec2(-1.5, -1.5)));
    posP_9 = (posP_9 + (tmpvar_63 * vec2(1.5, 1.5)));
    offNP_8 = (tmpvar_63 * vec2(2.0, 2.0));
    for (int i_3 = 0; i_3 < 8; i_3++) {
      if (!(doneN_5)) {
        highp vec4 tmpvar_66;
        lowp vec4 tmpvar_67;
        tmpvar_67 = textureGrad (_MainTex, posN_10, offNP_8, offNP_8);
        tmpvar_66 = tmpvar_67;
      ...
      if (!(doneP_4)) {
        ...
        lowp vec4 tmpvar_69;
        tmpvar_69 = textureGrad (_MainTex, posP_9, offNP_8, offNP_8);
        tmpvar_68 = tmpvar_69;
