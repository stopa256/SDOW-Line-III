...
void main ()
{
  ...
  c_4.w = 1.0;
  c_1.w = c_4.w;
  c_1.xyz = (c_4.xyz + (tmpvar_2 * xlv_TEXCOORD1));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  tmpvar_3 = _Color.xyz;
  tmpvar_2 = tmpvar_3;
  c_1.xyz = (tmpvar_2 * (2.0 * texture (unity_Lightmap, xlv_TEXCOORD0).xyz));
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_4;
  lowp vec3 tmpvar_5;
  tmpvar_5 = (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD0).xyz);
  lm_4 = tmpvar_5;
...
void main ()
{
  ...
  mediump vec3 lm_4;
  lowp vec3 tmpvar_5;
  tmpvar_5 = (2.0 * texture (unity_Lightmap, xlv_TEXCOORD0).xyz);
  lm_4 = tmpvar_5;
  mediump vec3 tmpvar_6;
  tmpvar_6 = (tmpvar_2 * lm_4);
  c_1.xyz = tmpvar_6;
...
void main ()
{
  ...
  c_10.w = 1.0;
  c_1.w = c_10.w;
  c_1.xyz = (c_10.xyz + (tmpvar_2 * xlv_TEXCOORD1));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  highp float dist_6;
  lowp float tmpvar_7;
  tmpvar_7 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD1).x;
  dist_6 = tmpvar_7;
  highp float tmpvar_8;
  tmpvar_8 = _LightShadowData.x;
  lightShadowDataX_5 = tmpvar_8;
  ...
  tmpvar_4 = tmpvar_9;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD0).xyz), vec3((tmpvar_4 * 2.0))));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_10;
  lowp vec3 tmpvar_11;
  tmpvar_11 = (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD0).xyz);
  lm_10 = tmpvar_11;
  lowp vec3 tmpvar_12;
...
void main ()
{
  ...
  c_7.w = 1.0;
  c_1.w = c_7.w;
  c_1.xyz = (c_7.xyz + (tmpvar_2 * xlv_TEXCOORD1));
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  c_8.w = 1.0;
  c_1.w = c_8.w;
  c_1.xyz = (c_8.xyz + (tmpvar_2 * xlv_TEXCOORD1));
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp float shadow_4;
  lowp float tmpvar_5;
  tmpvar_5 = shadow2DEXT (_ShadowMapTexture, xlv_TEXCOORD1.xyz);
  highp float tmpvar_6;
  tmpvar_6 = (_LightShadowData.x + (tmpvar_5 * (1.0 - _LightShadowData.x)));
  shadow_4 = tmpvar_6;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD0).xyz), vec3((shadow_4 * 2.0))));
  c_1.w = 1.0;
  gl_FragData[0] = c_1;
}
...
void main ()
{
  ...
  lowp float shadow_4;
  mediump float tmpvar_5;
  tmpvar_5 = texture (_ShadowMapTexture, xlv_TEXCOORD1.xyz);
  lowp float tmpvar_6;
  tmpvar_6 = tmpvar_5;
  highp float tmpvar_7;
  tmpvar_7 = (_LightShadowData.x + (tmpvar_6 * (1.0 - _LightShadowData.x)));
  shadow_4 = tmpvar_7;
  c_1.xyz = (tmpvar_2 * min ((2.0 * texture (unity_Lightmap, xlv_TEXCOORD0).xyz), vec3((shadow_4 * 2.0))));
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  mediump vec3 lm_7;
  lowp vec3 tmpvar_8;
  tmpvar_8 = (2.0 * texture2D (unity_Lightmap, xlv_TEXCOORD0).xyz);
  lm_7 = tmpvar_8;
  lowp vec3 tmpvar_9;
...
void main ()
{
  ...
  tmpvar_11 = (tmpvar_2 * min (lm_8, tmpvar_10));
  c_1.xyz = tmpvar_11;
  c_1.w = 1.0;
  _glesFragData[0] = c_1;
}
...
void main ()
{
  ...
  highp vec3 tmpvar_8;
  tmpvar_8 = (tmpvar_7.xyz + xlv_TEXCOORD1);
...
void main ()
{
  ...
  tmpvar_4 = tmpvar_5;
  lowp vec4 tmpvar_6;
  tmpvar_6 = textureProj (_LightBuffer, xlv_TEXCOORD0);
  light_3 = tmpvar_6;
  mediump vec4 tmpvar_7;
  tmpvar_7 = -(log2(max (light_3, vec4(0.001, 0.001, 0.001, 0.001))));
  light_3.w = tmpvar_7.w;
...
void main ()
{
  ...
  tmpvar_15 = (tmpvar_7 * light_6.xyz);
  c_14.xyz = tmpvar_15;
  c_14.w = 1.0;
  c_2 = c_14;
  tmpvar_1 = c_2;
...
void main ()
{
  ...
  tmpvar_7 = tmpvar_8;
  lowp vec4 tmpvar_9;
  tmpvar_9 = textureProj (_LightBuffer, xlv_TEXCOORD0);
  light_6 = tmpvar_9;
  mediump vec4 tmpvar_10;
  tmpvar_10 = -(log2(max (light_6, vec4(0.001, 0.001, 0.001, 0.001))));
  light_6.w = tmpvar_10.w;
